...
const Home = ({userAction}) => {
  ...
  return (
    <div className="bg-[#fff] min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-6 gap-4">
          <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
            <input
              ...
              className="border border-gray-300 p-3 h-[35px] rounded-lg w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-black"
            />
            <input
              type="date"
              value={searchDate}
            ...
            <button
              ...
              className="bg-black text-white px-6  h-[35px] rounded-lg hover:bg-[#222426] transition duration-300"
            >
              Search
            </button>
          </div>
